.. Software Engineering for Science documentation master file, created by
   sphinx-quickstart on Wed Aug 26 10:21:59 2020.
...
These notes started life as module in a postgraduate workshop taught at the University of Glasgow as part of the Scottish Universities Physics Alliance (SUPA), but they've been added to since then, and cover a slightly broader scope than that module.
I also assume you have some knowledge of a programming language; most of the concepts discussed will work for any language, but most of the examples will use Python. This means that you'll need to figure out the best way to do some things in your own language, but hopefully I'll have provided the scaffolding for that learning.
